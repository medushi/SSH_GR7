...
Videochat.App = (function (viewModel, connectionManager) {
    var _mediaStream,
        _hub,
        
        _connect = function(username, onSuccess, onFailure) {
            // Set Up SignalR Signaler
            var hub = $.connection.videochat;
            $.support.cors = true;
            $.connection.hub.url = '/SignalR/Hubs';
            $.connection.hub.start()
                .done(function () {
                    //console.log('connected to SignalR hub... connection id: ' + _hub.connectionId);
...
})(Videochat.ViewModel, Videochat.ConnectionManager);
