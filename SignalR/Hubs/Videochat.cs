...
using SistemeTeShperndaraGR7.Models.Chat;
using System;
...
namespace SistemeTeShperndaraGR7.SignalR.Hubs
{
    public class Videochat:Hub
    {
        ...
        public void AnswerCall(bool acceptCall, string targetConnectionId)
        {
            ...
            UserCalls.Add(new Models.Chat.UserCall
            {
                Users = new List<Models.Chat.User> { callingUser, targetUser }
            });
        ...
        private Models.Chat.UserCall GetUserCall(string connectionId)
        {
            var matchingCall =
